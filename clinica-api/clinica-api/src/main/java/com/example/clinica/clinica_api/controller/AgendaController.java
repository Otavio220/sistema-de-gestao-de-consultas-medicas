...
public class AgendaController {
    ...
    public ResponseEntity<List<AgendaDTO>> listarDisponiveisPorData(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate data) {
        return ResponseEntity.ok(agendaService.listarDisponiveisPorData(data));
    }
