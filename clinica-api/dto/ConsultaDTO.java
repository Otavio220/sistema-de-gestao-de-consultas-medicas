...
public class ConsultaDTO {
    ...
    // --- Médico ---
    // medicoId: opcional no agendamento — se não informado, o sistema atribui automaticamente
    private Long medicoId;
    private String medicoNome;

    // --- Especialidade ---
    // Obrigatório quando medicoId não for informado (atribuição automática)
    private Long especialidadeId;
    private String especialidadeNome;

    // --- Consultório ---
    // consultorioId: opcional — se não informado, o sistema atribui automaticamente
    private Long consultorioId;
    private String consultorioNome;

    // --- Aviso de requisitos prévios ---
    // Retornado na resposta do agendamento quando existirem requisitos
    private String avisoRequisitosPrevios;
    ...
    public String getAvisoRequisitosPrevios() { return avisoRequisitosPrevios; }
    public void setAvisoRequisitosPrevios(String avisoRequisitosPrevios) {
        this.avisoRequisitosPrevios = avisoRequisitosPrevios;
    }
}